...
const userRegister = async(req,res) => {
   try {
    const { name,email,password,phone, address, city, state, pincode, vehicleType, vehicleModel, preferredConnector } = req.body;
...
const deleteuser = async (req, res) => {
  try {
    ...
    if (!deletedStation) return res.status(404).json({ message: "User not found" });
...
module.exports = { userRegister , userLogin , userLogout , getalluser , updateuser , deleteuser , getuserbyid,userTotal }
